...
character1 = Game("교수님", 10, 100, 50)
character2 = Game("교수님", 8, 60, 100)

# 각 객체가 사용할 수 있는 메소드 실행
character1.display_info()
character1.attack("학생")
character1.cast_spell("과제 공격")
character1.heal(20)

print("\n")

character2.display_info()
character2.attack("시험기간 지친 학생")
character2.cast_spell("시험 화살")
character2.heal(30)